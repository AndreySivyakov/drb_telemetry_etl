...
The 'databricks_telemetry' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/databricks_telemetry/`: Shared Python code that can be used by jobs and pipelines.
